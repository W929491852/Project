...
<div id="right" class="right">
    ...
    <a href="javascript:dd_close();">关闭</a></div>
...
<div id="main">
    ...
    <div id="catList">
        ...
        <div class="book_sort">
            ...
            <c:forEach items="${bookTypes}" var="x">
            	<div class="book_cate"><a href="showbook?bigtid=${x.id}">${x.name}</a></div>
            	<div class="book_sort_bottom">
            		<c:forEach items="${x.subTypes}" var="y">
            			<a href="showbook?smalltid=${y.id}">${y.name}</a>&nbsp;
            		</c:forEach>
            	</div>
            </c:forEach>
        </div>
        ...
        <div class="book_sort">
            ...
            <div class="book_class" style="height:250px;">
                ...
                <dl id="book_history">
                    ...
                    <dd><span class="book_title">《中国时代》（上）</span><br />
                        作者：师永刚，邹明　主编 <br />
                        出版社：作家出版社 <br />
                        <span class="book_publish">出版时间：2009年10月</span><br />
                        定价：￥39.00<br />
                        当当价：￥27.00 </dd>
                    <dt><img src="images/dd_history_2.jpg" alt="history"/></dt>
                    <dd><span class="book_title">中国历史的屈辱</span><br />
                        作者：王重旭　著 <br />
                        出版社：华夏出版社 <br />
                        <span class="book_publish">出版时间：2009年11月</span><br />
                        定价：￥26.00<br />
                        当当价：￥18.20 </dd>
                    <dt><img src="images/dd_history_3.jpg" alt="history"/></dt>
                    <dd><span class="book_title">《中国时代》（下）</span><br />
                        作者：师永刚，邹明　主编 <br />
                        出版社：作家出版社 <br />
                        <span class="book_publish"> 出版时间：2009年10月</span><br />
                        定价：￥38.00<br />
                    ...
                    <dd><span class="book_title">大家国学十六讲</span><br />
                        作者：张荫麟，吕思勉 著 <br />
                        出版社：中国友谊出版公司 <br />
                        <span class="book_publish">出版时间：2009年10月</span><br />
                        定价：￥19.80<br />
                ...
                <dl id="book_family" class="book_none">
                    ...
                    <dd><span class="book_title">嘿，我知道你</span><br />
                        作者：兰海　著 <br />
                        出版社：中国妇女出版社 <br />
                        <span class="book_publish">出版时间：2009年10月</span><br />
                        定价：￥28.80<br />
                    ...
                    <dd><span class="book_title">择业要趁早</span><br />
                        作者：（美）列文<br />
                        出版社：海天出版社 <br />
                        <span class="book_publish">出版时间：2009年10月</span><br />
                        定价：￥28.00<br />
                    ...
                    <dd><span class="book_title">爷爷奶奶的“孙子兵法”</span><br />
                        作者：伏建全 编著 <br />
                        出版社：地震出版社 <br />
                        <span class="book_publish"> 出版时间：2009年8月</span><br />
                        定价：￥28.00<br />
                        当当价：￥17.40 </dd>
                    <dt><img src="images/dd_family_4.jpg" alt="history"/></dt>
                    <dd><span class="book_title">1分钟读懂孩子心理</span><br />
                        作者：海韵　著 <br />
                        出版社：朝华出版社 <br />
                        <span class="book_publish">出版时间：2009年10月</span><br />
                        定价：￥28.00<br />
        ...
        <div class="book_sort">
            ...
            <div class="book_class">
                <div id="dome">
                    <div id="dome1">
                        <ul id="express">
                          <c:forEach items="${express}" var="str">
                          	<li>${str}</li>
                          </c:forEach>
                        </ul>
                    </div>
