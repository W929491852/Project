				...
				<table width="95%" border="1" cellspacing="0" cellpadding="0"
					...
					<tr>
						...
						<td width="88" class="rd8">
							<a href="#"
								onClick="window.open('checkvou_detail.jsp', '盘点详细信息', 'width=800, height=400, scrollbars=no')">200706260001</a>
						</td>
						...
						<td nowrap class="rd19" width="64%">
							<div align="right">
								...
								<input name="btnAdd" type="button" class="button1" id="btnAdd6"
									value="添加" onClick="self.location='checkvou_add.jsp'">
								<input name="btnDelete" class="button1" type="button"
									id="btnDelete" value="删除" onClick="confirm('你是否真的删除所选的产品?');">
								<input name="btnModify" class="button1" type="button"
									id="btnModify" value="修改"
									onClick="self.location='checkvou_modify.jsp'">
								<input name="btnAudit" class="button1" type="button"
									id="btnAudit" onClick="self.location='checkvou_audit.jsp'" value="送审">
							</div>
						</td>
					</tr>
				</table>
