...
<body>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
	  ...
	  <tr>
		...
		<td class="main_locbg font2"><img src="${ctx}/images/pointer.gif">&nbsp;&nbsp;&nbsp;当前位置：报表管理 &gt; 报表查询</td>
	  ...
	  <tr valign="top">
	    <td height="30">
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr>
			  <td class="fftd">
			  	<form name="jobform" method="post" id="jobform" action="${ctx}/job/selectJob?t=2">
				    <table width="100%" border="0" cellpadding="0" cellspacing="0">
					  <tr>
					    <td class="font3">
					    	...
					    	<a href="${ctx}/poi/createBb?t=1">生成PDF</a>
					    	<a href="${ctx}/poi/createBb?t=2">生成Excel</a>
					    </td>
					  </tr>
					</table>
				</form>
