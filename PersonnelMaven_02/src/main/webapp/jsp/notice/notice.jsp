	...
	$(function(){
	 		   ...
	 		   if(checkedBoxs.length < 1){
	 			   ...
	 			   $.ligerDialog.confirm("确认要删除吗?","删除公告",function(r){
	 				   if(r){
	 					   // alert("删除："+ids.get());
	 					   // 发送请求
	 					   window.location = "${ctx }/jsp/notice/removeNotice?ids=" + ids.get();
	 				   }
	 			   });
	 		   }
	 	   })
		...
		$("a[id^='prev_'").click(function(){
			...
			$.ligerDialog.open({ 
				title:'预览公告',
				height: 500, 
				url: '${ctx}/jsp/notice/previewNotice?id='+noticeId, 
				width: 750, 
				showMax: true, 
				showToggle: true, 
				showMin: true, 
	...
	<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
	  ...
	  <tr valign="top">
	    <td height="30">
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr>
			  <td class="fftd">
			  	<form name="noticeform" method="post" id="noticeform" action="${ctx}/jsp/notice/selectNotice">
				    <table width="100%" border="0" cellpadding="0" cellspacing="0">
					  <tr>
					    <td class="font3">
			...
			<c:forEach items="${requestScope.notices}" var="notice" varStatus="stat">
				<tr id="data_${stat.index}" align="center" class="main_trbg" onMouseOver="move(this);" onMouseOut="out(this);">
					<td><input type="checkbox" id="box_${stat.index}" value="${notice.id}"></td>
					 ...
					 <td align="center" width="40px;"><a href="${ctx }/jsp/notice/updateNotice?flag=1&id=${notice.id}">
	  ...
	  <tr valign="top"><td align="center" class="font3">
	  	 <fkjava:pager
	  	        ...
	  	        style="digg"
	  	        submitUrl="${ctx}/jsp/notice/selectNotice"/>
	  </td></tr>
	</table>
