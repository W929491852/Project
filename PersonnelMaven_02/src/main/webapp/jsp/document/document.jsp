	...
	<script type="text/javascript">
	    $(function(){
	 		   ...
	 		   if(checkedBoxs.length < 1){
	 			   ...
	 			   $.ligerDialog.confirm("确认要删除吗?","删除文档",function(r){
	 				   if(r){
	 					   // alert("删除："+ids.get());
	 					   // 发送请求
	 					   window.location = "${ctx }/jsp/document/removeDocument?ids=" + ids.get();
	 				   }
	 			   });
	 		   }
	 	   })
	    	...
	    	$("a[id^='down_']").click(function(){
	    		...
	    		/** 下载该文档 */
	    		window.location = "${ctx}/jsp/document/downLoad?id="+id;
	    	})
	...
	<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
	  ...
	  <tr valign="top">
	    <td height="30">
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr>
			  <td class="fftd">
			  	<form name="documentform" method="post" id="documentform" action="${ctx }/jsp/document/selectDocument">
				    <table width="100%" border="0" cellpadding="0" cellspacing="0">
					  <tr>
					    <td class="font3">
			...
			<c:forEach items="${requestScope.documents}" var="document" varStatus="stat">
				<tr ondblclick="down(${document.id});"  class="main_trbg" align="center" id="data_${stat.index}">
					<td><input type="checkbox" id="box_${stat.index}" value="${document.id}"></td>
					 ...
					 <td align="center" width="40px;"><a href="${ctx }/jsp/document/updateDocument?flag=1&id=${document.id}">
	  ...
	  <tr valign="top"><td align="center" class="font3">
	  	   <fkjava:pager 
	  	      ...
	  	      submitUrl="${ctx}/jsp/document/selectDocument"
	  	      style="flickr"
	  	      />
	  </td></tr>
	</table>
