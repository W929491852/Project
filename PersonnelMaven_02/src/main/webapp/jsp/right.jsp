...
<script type="text/javascript">
	$(function() {
		$.get("${ctx}/jsp/sign/addSign?flag=1&user_id=" + $("#user_id").val(),
				function(data) {
					if (data == "1") {
						$("#qiandao").val("已打卡");
					}
		...
		$("#qiandao").click(
				function() {
					$.get("${ctx}/jsp/sign/addSign?flag=2&user_id="
							+ $("#user_id").val(), function(data) {
						if (data == "1") {
							$("#qiandao").val("已打卡");
							alert("打卡成功");
						} else if (data == "-1") {
	...
	<table width="100%" height="90%" border="0" cellpadding="10"
		...
		<tr valign="top">
			<td><input type="hidden"
				value="${sessionScope.user_session.id }" id="user_id" />
				<table width="100%" border="0" cellpadding="0" cellspacing="10"
					...
					<tr>
						<td class="font3 fftd">打卡按钮：<font color="red" size="2">
								<input type="button" id="qiandao" value="打卡"
								style="border: 1px solid red; width: 80px">
						</font>
						</td>
					</tr>
					<tr>
