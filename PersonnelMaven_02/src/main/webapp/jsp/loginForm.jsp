...
<script src="${ctx }/js/metronic/plugins/jquery.cookie.js"></script>
...
<body style="font-family: 微软雅黑">
					...
					<div class="control-group">
						<div class="controls">
							<div class="input-icon left"><input
								class="m-wrap placeholder-no-fix" type="checkbox" style="color:red" id="ishave" name="ishave"/>记住账号
							</div>
						</div>
					</div>
				</div>
	...
	<script type="text/javascript" src="${ctx}/js/metronic/scripts/app.js"></script>
	<script type="text/javascript" src="${ctx}/js/metronic/scripts/lock.js"></script>
	<script type="text/javascript">
		$(function() {
			App.init();
			Lock.init();
