...
<script type="text/javascript" src="${ctx }/js/jstimer.js"></script>
<script type="text/javascript">
    ...
    $(function(){
    	...
    	$("#exit").click(function(){
    		...
    		parent.location = "${ctx}/jsp/user/logout.action";
    	})
	})
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="320" height="80" class="topbg"><img src="${ctx}/images/top_logo.jpg" width="320" height="80"></td>
	<td class="topbg">
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
	    <tr>
