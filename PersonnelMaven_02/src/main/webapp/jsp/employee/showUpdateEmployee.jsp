...
<body>
	...
	<table width="100%" height="90%" border="0" cellpadding="5"
		...
		<tr valign="top">
			<td>
				<form action="${ctx}/jsp/employee/updateEmployee" id="employeeForm"
					method="post">
					<!-- 隐藏表单，flag表示添加标记 -->
					<input type="hidden" name="flag" value="2"> <input
						type="hidden" name="id" value="${employee.id }"> <input
						type="hidden" name="createDate" value="${employee.createDate }">
								...
								<table>
									...
									<tr>
										...
										<td class="font3 fftd">职&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;位：
											<select id="job.id" name="job.id" style="width: 143px;">
